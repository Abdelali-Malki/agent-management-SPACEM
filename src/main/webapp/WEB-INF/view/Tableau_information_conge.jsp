											...
											<div class="table-wrapper">
												<div class="table-title">
													<div class="row">
														<div class="col-sm-5">
															<h2>
																Liste <b>des congés</b>
															</h2>
														</div>
															<div class="col-sm-7">
															<a href="/emp/formulaire_employee" class="btn btn-secondary">
															<i class="pe-7s-news-paper">&#xE147;</i> <span>Nouvelle demande de congé</span></a>
														</div>
													</div>
												</div>
												<table class="table table-striped table-hover">
													...
													<tbody>
														<tr th:each="conge:${listConge}">
															<td th:text="${conge.cin}"></td>
															<td th:text="${conge.nom}">
															</th>
															<td th:text="${conge.prenom}">
															</th>
															<td th:text="${conge.raison}">
															</th>
															<td th:text="${conge.datedeb}">
															</th>
															<td th:text="${conge.datefin}">
															</th>
															<th><a type="button" class="btn btn-danger"
																th:href="@{/cong/deleteCong(id=${conge.id})}">
																	Supprimer </a></th>
															<th><a type="button" class="btn btn-info"
																th:href="@{/cong//modifyCong(id=${conge.id})}">
																	Modifier </a></th>
														</tr>
													</tbody>
												</table>
