											...
											<div class="table-wrapper">
												<div class="table-title">
													<div class="row">
														<div class="col-sm-5">
															<h2>
																Liste <b>des demandes d'attestation de stage</b>
															</h2>
														</div>
												...
												<table class="table table-striped table-hover">
													...
													<tbody>
														<tr th:each="attestation:${listStage}">
															<td th:text="${attestation.cin}"></th>
															<td th:text="${attestation.nom}">
															</th>
															<td th:text="${attestation.prenom}">
															</th>
															<td th:text="${attestation.datedeb}">
															<td th:text="${attestation.datefin}">
															</th>
															<td th:text="${attestation.departement}">
															
															<th><a type="button" class="btn btn-danger"
																th:href="@{/att/deleteAtt(id=${attestation.id})}">
																	Supprimer </a></th>
															<th><a type="button" class="btn btn-info"
																th:href="@{/att/modifyAtt(id=${attestation.id})}">
																	Modifier </a></th>
														</tr>
													</tbody>
												</table>
