            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Choix de l'agent :</h4>
							...
							<div class="content table-responsive table-full-width">
                                 ...
                                 <div class="container">
                                  ...
                                  <div class="middle">
                                  <div class="text"><a href="/emp/typedemande_emp">Employé</a></div>
                                  </div>
                                 </div>  
                                  <div class="container">
                                <img src="/assets/img/inter.png" alt="Avatar" class="image" style="width:100%">
                                    <div class="middle">
                                     <div class="text"><a href="/stg/formulaire_demandesta">Stagiaire</a></div>
                                     </div>
                                        </div>
                                   </body>
                            </div>
