            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Création des comptes :</h4>
                                <p class="category">Veuillez sélectionner l'agent qui correspond</p>
                            </div>
                            <center>
							<div class="content table-responsive table-full-width">
                                  
                                 <div class="container">
                                  <img src="/assets/img/employe.png" alt="Avatar" class="image" style="width:100%">
                                  <div class="middle">
                                  <div class="text"><a href="/emp/formulaire_employee">Employé</a></div>
                                  </div>
                                 </div>  
                                  <div class="container">
                                <img src="/assets/img/inter.png" alt="Avatar" class="image" style="width:100%">
                                    <div class="middle">
                                     <div class="text"><a href="/stg/formulaire_stagiaire">Stagiaire</a></div>
                                     </div>
                                        </div>
                                   </body>
                            </div>
