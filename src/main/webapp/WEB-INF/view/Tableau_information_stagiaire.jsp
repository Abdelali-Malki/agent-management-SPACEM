											...
											<div class="table-wrapper">
												<div class="table-title">
													<div class="row">
														<div class="col-sm-5">
															<h2>
																Liste <b>des Stagiaires</b>
															</h2>
														</div>
														<div class="col-sm-7">
															<a href="/stg/formulaire_stagiaire" class="btn btn-secondary"><i
																class="pe-7s-add-user">&#xE147;</i> <span>Ajouter
																	nouveau stagiaire</span></a> 
														</div>
													</div>
												</div>
												<table class="table table-striped table-hover">
													...
													<tbody>
														<tr th:each="stagiaire:${listStg}">
															<td th:text="${stagiaire.cin}">
															</th>
															<td th:text="${stagiaire.nom}">
															</th>
															<td th:text="${stagiaire.prenom}">
															</th>
															<td th:text="${stagiaire.email}">
															</th>
															<td th:text="${stagiaire.dateD}">
															<td th:text="${stagiaire.dateF}">
															</th>
															<td th:text="${stagiaire.ville}">
															
															<th><a type="button" class="btn btn-danger"
																th:href="@{/stg/deleteStg(id=${stagiaire.id})}">
																	Supprimer </a></th>
															<th><a type="button" class="btn btn-info"
																th:href="@{/stg/modifyStg(id=${stagiaire.id})}">
																	Modifier </a></th>
														</tr>
													</tbody>
												</table>
