											...
											<div class="table-wrapper">
												<div class="table-title">
													<div class="row">
														<div class="col-sm-5">
															<h2>
																Liste <b>des départs</b>
															</h2>
														</div>
															<div class="col-sm-7">
															<a href="/emp/formulaire_employee" class="btn btn-secondary">
															<i class="pe-7s-news-paper">&#xE147;</i> <span>Nouvelle demande de départ</span></a>
														</div>
													</div>
												</div>
												<table class="table table-striped table-hover">
													...
													<tbody>
														<tr th:each="depart:${listDepart}">
															<td th:text="${depart.cin}"></td>
															<td th:text="${depart.nom}">
															</th>
															<td th:text="${depart.prenom}">
															</th>
															<td th:text="${depart.departement}">
															</th>
															<td th:text="${depart.daterec}">
															</th>
															<td th:text="${depart.poste}">
															</th>

															<th><a type="button" class="btn btn-danger"
																th:href="@{/dep//deleteDep(id=${depart.id})}">
																	Supprimer </a></th>
															<th><a type="button" class="btn btn-info"
																th:href="@{/dep/modifyDep(id=${depart.id})}">
																	Modifier </a></th>
														</tr>
													</tbody>
												</table>
